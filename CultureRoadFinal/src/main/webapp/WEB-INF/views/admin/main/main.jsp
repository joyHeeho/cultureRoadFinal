...
<%@ include file="/WEB-INF/views/common/userLogin.jspf"%> 
	...
	$(function(){
		...
		<!-- 메인이지롱
		<button type="button" id="adminLogout" name="adminLogout">로그아웃</button>
		<a href="/adminPage/noticeBoard">공지게시판</a>
		<a href="/adminPage/qnaBoard">q&a게시판</a>
		<a href="/adminPage/userManagement">사용자관리</a>
		<a href="/adminPage/replyManagement">댓글관리</a>
		<a href="/adminPage/commentManagement">한줄평관리</a> -->
     ...
     <!-- partial:partials/_navbar.html -->
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="/adminLogin/main"><img src="/resources/main/image/logo.png" alt="logo"/></a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/adminLogin/main">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/admin/admincommentList">
