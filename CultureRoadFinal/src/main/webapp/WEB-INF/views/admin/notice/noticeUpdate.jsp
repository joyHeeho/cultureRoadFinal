						...
						<tbody>
							<tr>
								...
								<td class="text-left">
									...
									<input type="text" class="form-control" id="noc_title" name="noc_title" value="${detail.noc_title }">
								</td>
							</tr>
							<tr>
								<td>글내용</td>
								<td class="text-left">
									<textarea rows="30" cols="10" class="form-control" style="resize: none" name="noc_content" id="noc_content" rows="8">${detail.noc_content }</textarea>
								</td>
							</tr>
<!-- 							<tr> -->
<!-- 								<td>파일첨부</td> -->
