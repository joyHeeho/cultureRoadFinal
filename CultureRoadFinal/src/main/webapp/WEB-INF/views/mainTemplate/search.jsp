...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
	<div class="container-fluid">
		<form id="search" name="search" class="d-flex">
			<input type="text" class="form-control me-2" placeholder="영화를 검색하세요." name="title" id="title">
			<button class="btn btn-outline-secondary" type="submit" id="searchBtn" name="searchBtn">
				<img src="https://s3.ap-northeast-2.amazonaws.com/cdn.wecode.co.kr/icon/search.png" alt="Search" class="img-fluid">
			</button>
		</form>
	</div>
...
<body>
	...
	<div class="contentContainer container">
		<div class="row">
			<div id="div_calendar" style="width: 1000px;">
