			...
			<div class="text-end">
				<c:if test="${detail.user_no == userLogin.userNo}">
					<form id="mvBoardModify">
						...
						<input type="button" class="btn btn-success btn-md" id="updateBtn" value="수정">
						<input type="button" class="btn btn-danger btn-md" id="deleteBtn" name="deleteBtn" value="삭제">
